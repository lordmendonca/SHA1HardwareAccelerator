...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../SHA1_Base.sopcinfo
...
# Design Name 
# setting SOPC_NAME is SHA1_Base
SOPC_NAME := SHA1_Base
...
# setting hal.stderr is jtag_uart_core
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_core

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_core
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_core
...
# setting hal.stdout is jtag_uart_core
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_core
